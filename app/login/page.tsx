...
const googleErrors: Record<string, string> = {
  ...
  no_email: "No email returned from Google. Please try a different account.",
...
function GoogleErrorBanner() {
  ...
  return (
    ...
    >
      {googleErrors[googleError] ?? "Something went wrong."}
    </div>
  );
}
...
export default function LoginPage() {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(160deg, #0D1F3C 0%, #172D54 60%, #F8F6F1 100%)",
      }}
    >
      <div
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          >
            Sign in to read the latest CEO insights
          </p>
        </div>
        <LoginForm />
        <p
